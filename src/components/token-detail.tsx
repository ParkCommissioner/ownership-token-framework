...
import { calculateQualitativeProfile } from "@/lib/qualitative-score-utils"
import { getTokenById } from "@/lib/token-data"
import { formatUnixTimestamp } from "@/lib/utils"
import AnalyticsContent from "./analytics-content"
import InfoSidebar from "./info-sidebar"
import { NewsletterSignup } from "./newsletter-signup.tsx"
import { QualitativeAssessmentCard } from "./qualitative-assessment-card"
...
export default function TokenDetail({ tokenId }: TokenDetailProps) {
  ...
  // Calculate qualitative profile
  const qualitativeProfile = calculateQualitativeProfile(token, metrics)
